...
async function getdate(valu, lat) {
  let weather = await fetch(
    `https://api.weatherapi.com/v1/forecast.json?key=7ccf0f2652c4433cb18125030242501&q=${valu},${lat}&days=7  `
  );
...
navigator.geolocation.getCurrentPosition((pos) => {
  // console.log(pos);
  getdate(pos.coords.latitude, pos.coords.longitude);
});
